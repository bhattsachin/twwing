...
public final class Result {
  ...
  private final BarcodeFormatNow format;
  ...
  /**
   * @return {@link BarcodeFormatNow} representing the format of the barcode that was decoded
   */
  public BarcodeFormatNow getBarcodeFormat() {
    return format;
  }
